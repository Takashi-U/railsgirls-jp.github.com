...
*Created by Piotr Steininger, [@polishprince](https://twitter.com/polishprince),Updated by Takashi Uchibe*
...
db/migrate ディレクトリにも migration が追加されます。
...
{% highlight ruby %}
 User.create(:email=>"me@example.com",:password => "test1234", :password_confirmation => "test1234")
{% endhighlight %}
